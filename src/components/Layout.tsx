...
const BottomNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 pb-safe z-40 max-w-md mx-auto">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive ? "text-[#00BAF2]" : "text-gray-500 hover:text-gray-900"
              )}
            >
    ...
    <div className="min-h-screen bg-[#F5F9FC] font-sans flex flex-col md:flex-row justify-center md:px-4 md:py-6 lg:px-8 xl:gap-8">
      ...
      <div className="hidden md:flex flex-col w-64 flex-shrink-0 sticky top-6 h-[calc(100vh-3rem)]">
        <div className="mb-8 px-4">
          <h1 className="text-2xl font-extrabold text-[#002970] tracking-tight">PAYTM</h1>
          <div className="bg-[#002970] text-white text-[10px] font-bold py-1 px-2.5 rounded-full tracking-wider inline-block mt-1">
            BUSINESS DEMO
          </div>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-100 p-4 rounded-xl mt-auto">
          <p className="text-xs font-bold text-[#002970] uppercase tracking-wide">Prototype Mode</p>
          <p className="text-xs text-[#002970]/80 mt-1">No real money moves.</p>
        </div>
      </div>

      {/* Main Mobile/Desktop Content Area */}
      <div className="w-full md:max-w-md lg:max-w-lg xl:max-w-xl bg-white md:rounded-[2rem] md:shadow-xl md:border md:border-gray-100 min-h-screen md:min-h-0 md:h-[calc(100vh-3rem)] relative flex flex-col overflow-hidden">
        <DemoBanner />
      ...
      <div className="hidden xl:block w-72 flex-shrink-0 sticky top-6 h-[calc(100vh-3rem)]">
        <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 mb-4">
           <h3 className="text-sm font-bold text-gray-800 uppercase tracking-wide mb-3">About this prototype</h3>
           <p className="text-sm text-gray-600 mb-3">This is a case study prototype for the Paytm Innovation Challenge.</p>
           <p className="text-sm text-gray-600">It demonstrates a workflow for organising, tracking, and repeating outgoing business UPI payments.</p>
        </div>
      </div>
    </div>
  );
